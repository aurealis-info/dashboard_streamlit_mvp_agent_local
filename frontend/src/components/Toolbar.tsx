import type { FieldDefinition, ProjectStatus, ViewMode } from '../types'
...
export function Toolbar({ search, onSearch, status, onStatus, owner, owners, onOwner, focusOnly, onFocusOnly, onAddField, resultCount, view, onView, fields, onFieldVisibility }: ToolbarProps) {
  return (
